...
Implementación completa de un modelo de lenguaje causal — tokenizador manual, embeddings posicionales, multi-head attention (Q/K/V), normalización por capas y generación autorregresiva. Preentrenado sobre Alice in Wonderland.
...
Pipeline de recuperación de información con tres motores: TF-IDF léxico, búsqueda semántica densa con embeddings tok2vec (spaCy) y RAG con LLM local.
